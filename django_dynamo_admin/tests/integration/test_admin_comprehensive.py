...
from django_dynamo_admin.dynamodb_adapter.admin_filters import (
    IsActiveFilter,
    PublishedDateFilter,
    VoteCountFilter,
)
...
class TestDynamoDBAdminViews(TestDynamoDBAdminIntegration):
    ...
    @patch("dynamodb_adapter.managers.DynamoDBQuerySet.delete")
...
class TestDynamoDBAdminSite(TestDynamoDBAdminIntegration):
    ...
    def test_admin_site_index_context(self):
        ...
        from django_dynamo_admin.dynamodb_adapter.admin import dynamodb_admin_site
