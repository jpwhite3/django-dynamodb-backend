...
class TestDynamoDBMigration(TestCase):
    ...
    @patch("dynamodb_adapter.migrations_dynamo.DynamoDBMigrationState.exists")
    @patch("dynamodb_adapter.migrations_dynamo.DynamoDBMigrationState.create_table")
    ...
    @patch("dynamodb_adapter.migrations_dynamo.DynamoDBMigrationState.exists")
    @patch("dynamodb_adapter.migrations_dynamo.DynamoDBMigrationState.get")
...
class TestMigrationLoader(TestCase):
    ...
    @patch("dynamodb_adapter.migration_executor.apps.get_app_configs")
