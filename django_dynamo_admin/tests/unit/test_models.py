...
class TestDynamoDBModelMeta(TestCase):
    ...
    def test_abstract_model_handling(self):
        ...
        # Should not have _pynamodb_model_class or _needs_pynamodb_model
        self.assertFalse(hasattr(AbstractTestModel, "_needs_pynamodb_model"))
        self.assertIsNone(AbstractTestModel._pynamodb_model_class)
...
class TestDynamoDBModel(TestCase):
    ...
    @patch("dynamodb_adapter.models.PynamoDBModel.save")
    ...
    @patch("dynamodb_adapter.models.PynamoDBModel.delete")
...
class TestDynamoDBManager(TestCase):
    ...
    @patch("dynamodb_adapter.managers.DynamoDBQuerySet.get")
    ...
    def test_bulk_create(self):
        ...
        with patch.object(self.TestModel, "save") as mock_save:
            result = self.manager.bulk_create(objects)

            # Should save all objects
