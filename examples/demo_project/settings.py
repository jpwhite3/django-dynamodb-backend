...
ROOT_URLCONF = "examples.demo_project.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [BASE_DIR / "examples" / "demo_project" / "templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "examples.demo_project.wsgi.application"
...
STATICFILES_DIRS = [
    BASE_DIR / "examples" / "demo_project" / "static",
]
